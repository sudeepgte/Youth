            ...
            <div style="position: sticky; top: 20px;">
                ...
                <div style="background: var(--bg-card); border-radius: 20px; overflow: hidden; border: 1px solid var(--border-color); box-shadow: 0 10px 25px rgba(0,0,0,0.05); position: relative; margin-bottom: 20px;">
                    ...
                    <div style="padding: 25px;">
                        ...
                        <p id="prev-desc-display" style="font-size: 15px; color: var(--text-secondary); line-height: 1.6; margin: 0 0 20px 0;">This is where your compelling advertisement description will appear.</p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        setupLivePreview('prev-desc-input', 'prev-desc-display', 'This is where your compelling advertisement description will appear.');
...
$content = $content -replace '\$\{users\.size\(\)\}', '${users != null ? users.size() : 0}' -replace '\$\{posts\.size\(\)\}', '${posts != null ? posts.size() : 0}'
