...
$c = $c -replace '<th>Admin Commission \(7%\)</th>', '<th>Admin Commission</th><th>Payout Action</th>'

$pattern = '(?s)<td style="font-weight: 800; color: #10b981;"\s*th:text="\$\{[^}]+\}">\s*.*?</td>'
