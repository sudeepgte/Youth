...
public class AddLeaderboard {
    public static void main(String[] args) throws Exception {
        ...
        String leaderboardHtml = "            <!-- Global Leaderboard (visible on /battles) -->\n" +
        ...
        content = content.replace("<div class=\"widget-card\">\n                <div class=\"widget-header\">\n                    <!-- Title changes based on context -->\n\n                    <h3 th:if=\"${battle == null}\">", 
                                  leaderboardHtml + "<div class=\"widget-card\">\n                <div class=\"widget-header\">\n                    <!-- Title changes based on context -->\n\n                    <h3 th:if=\"${battle == null}\">");
        ...
        System.out.println("Leaderboard Added!");
    }
}
