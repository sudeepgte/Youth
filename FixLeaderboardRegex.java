...
public class FixLeaderboardRegex {
    public static void main(String[] args) throws Exception {
        ...
        String pattern = "(?s)<aside class=\"widgets\">\\s*<div class=\"widget-card\">\\s*<div class=\"widget-header\">\\s*<!-- Title changes based on context -->\\s*<h3 th:if=\"\\$\\{battle == null\\}\">";
        ...
        String leaderboardHtml = "<aside class=\"widgets\">\n" +
            ...
            "                </div>\n" +
            "            </div>\n\n            <div class=\"widget-card\">\n                <div class=\"widget-header\">\n                    <!-- Title changes based on context -->\n\n                    <h3 th:if=\"${battle == null}\">";
        
        Matcher m = Pattern.compile(pattern).matcher(content);
        if (m.find()) {
            content = m.replaceFirst(Matcher.quoteReplacement(leaderboardHtml));
            System.out.println("Widget inserted!");
        } else {
            System.out.println("Widget NOT inserted! Pattern not found.");
        }
        ...
        if (!content.contains("loadGlobalLeaderboard()")) {
            ...
            System.out.println("JS already there!");
        }
